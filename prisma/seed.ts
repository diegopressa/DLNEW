...
async function main() {
  ...
  await prisma.heroSection.create({
    data: {
      ...
      subtitle:
        "Nos encargamos de todo: prenda, estampado y entrega. Presupuesto inmediato y entrega en 24-48 horas.",
  ...
  const solutions = [
    {
      title: "Precio",
      description: "Gran variedad de opciones de calidad.",
      order: 1,
    },
    {
      title: "Personalización",
      description: "Estampado y bordado profesional.",
      order: 2,
    },
    {
      title: "Entrega",
      description: "Envíos a todo el país sin demora.",
      order: 3,
    },
    {
      title: "Rapidez",
      description: "Producción ágil y respuesta inmediata.",
      order: 4,
    },
  ];
  ...
  const categories = [
    ...
    {
      name: "Pantalones y Ropa de Trabajo",
      imageUrl:
